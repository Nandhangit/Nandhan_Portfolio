            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  "Developed backend applications using Python with Django and Flask frameworks.",
                  "Designed and implemented RESTful APIs for frontend–backend integration.",
                  "Worked with SQL databases for data storage, querying, and relationship management.",
                  ...
                  "Deployed frontend and full-stack applications using Vercel.",
                ].map((item, idx) => (
